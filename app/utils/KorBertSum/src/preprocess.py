...
if __name__ == '__main__':
    ...
    # SumAI/bertsum/raw_data/news/train_original.json
    # parser.add_argument("-map_path", default='../data/')
    parser.add_argument("-map_path", default='../data/')
    parser.add_argument("-raw_path", default='/opt/ml/SumAI/bertsum/raw_data/news/')
    parser.add_argument("-save_path", default='../bert_data2/')
    parser.add_argument("-vocab_file_path", default='../001_bert_morp_pytorch/vocab.korean_morp.list')
